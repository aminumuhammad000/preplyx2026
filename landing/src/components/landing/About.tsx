...
const About = () => {
  return (
    <section id="about" className="py-12 bg-gray-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight mb-4 leading-tight">
          ...
          {FEATURES.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white border border-gray-200/80 rounded-xl p-6 shadow-2xs hover:shadow-md hover:border-gray-300 transition-all duration-200 flex flex-col justify-between"
              >
                <div>
